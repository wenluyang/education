...
public interface SysLoginLogMapper{
	 ...
	 * @return
	 */
    int updateSysLoginLog(@Param("enti") SysLoginLog value, @Param("assist") Assist assist);
	/**
	 ...
	 * @return
	 */
    int updateNonEmptySysLoginLog(@Param("enti") SysLoginLog value, @Param("assist") Assist assist);
}