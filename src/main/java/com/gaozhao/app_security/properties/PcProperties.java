...
public class PcProperties {
     ...
     * 登录访问的url
     */
    private String signInUrl=SecurityConstants.DEFAULT_SIGN_IN_PROCESSING_URL_PC;

    /**
     * 登录请求中，账号对应参数名
     */
    private String signInAccountParamName=SecurityConstants.DEFAULT_SIGN_IN_PARAMETER_USERNAME_PC;

    /**
     * 登录请求中，密码对应的参数名
     */
    private String signInPwdParamName=SecurityConstants.DEFAULT_SIGN_IN_PARAMETER_PASSWORD_PC;
